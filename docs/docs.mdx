...
- **Arrow Left/Down**: Move slider by 1%
- **Arrow Right/Up**: Move slider by 1%
- **Shift + Arrow**: Move slider by 10%
- **Home**: Move to minimum position
- **End**: Move to maximum position

Keyboard navigation respects `minDragBound` and `maxDragBound` constraints and is disabled for the `fixed` variant.
